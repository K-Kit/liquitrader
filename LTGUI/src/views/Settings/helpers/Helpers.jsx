...
function generate_table() {
    ...
    lines.forEach((line) => {
        ...
        if (line.indexOf(';') !== -1) {
            ...
            settings[current_header][header_and_values[0]] = header_and_values[1].split(',');
        }
    });
    ...
    let section_start_format = '<div class="config-section"><span class="config-header">{0}</span>';
    let setting_line_format = '<div class="config-line"><div class="setting-label-container"><span class="setting-label">{0}</span></div><div class="setting-input-group">';
    let setting_input_format = '<input class="setting-input" id="{0}_{1}" value="{2}" />';
